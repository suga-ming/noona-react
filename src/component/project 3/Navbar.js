      ...
      <div className="login-button">
        ...
        <div className="category-area">
          <div className="category">
            <span className="navigate">여성</span>
            <span className="navigate">Divided</span>
            <span className="navigate">남성</span>
            <span className="navigate">신생아/유아</span>
            <span className="navigate">아동</span>
            <span className="navigate">H&M HOME</span>
            <span className="navigate">Sale</span>
            <span className="navigate">지속가능성</span>
          </div>
          <div>
